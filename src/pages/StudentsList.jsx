      ...
      <header className="sticky top-0 z-50 bg-gray-900 border-b border-white/10 px-6 py-4 shadow-2xl">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <button 
              onClick={() => navigate('/')} 
              className="p-2 hover:bg-white/5 rounded-full group"
            >
          ...
          <div className="relative w-full md:max-w-md">
            ...
            <input 
              ...
              className="w-full bg-black border border-white/10 rounded-xl py-2.5 pl-11 pr-10 text-sm focus:ring-2 focus:ring-indigo-500 outline-none"
              value={searchTerm}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredStudents.map((student) => (
                <div 
                  ...
                  className="bg-black/40 border border-white/5 p-6 rounded-2xl hover:border-indigo-500/50 hover:bg-indigo-600/5 cursor-pointer group h-44 flex flex-col justify-between"
                >
                  <div>
                    <h3 className="text-lg font-bold group-hover:text-indigo-400 truncate">
                      {student.name}
                    </h3>
